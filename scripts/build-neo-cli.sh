...
ln -s ${DPKGS_PATH}/neo-cli_${NEO_VERSION}-1_amd64/usr/bin/neo-cli /srv/neo-cli/neo-cli;
chmod -R a+rw ${DPKGS_PATH}/neo-cli_${NEO_VERSION}-1_amd64/srv/neo-cli/db;
chown -R root:root ${DPKGS_PATH}/neo-cli_${NEO_VERSION}-1_amd64/srv/neo-cli/db;
chown -R root:root ${DPKGS_PATH}/neo-cli_${NEO_VERSION}-1_amd64/srv/neo-cli/Plugins;
...
ln -s ${DPKGS_PATH}/neo-cli_${NEO_VERSION}-1_arm64/usr/bin/neo-cli /srv/neo-cli/neo-cli;
chmod -R a+rw ${DPKGS_PATH}/neo-cli_${NEO_VERSION}-1_arm64/srv/neo-cli/db;
chown -R root:root ${DPKGS_PATH}/neo-cli_${NEO_VERSION}-1_arm64/srv/neo-cli/db;
chown -R root:root ${DPKGS_PATH}/neo-cli_${NEO_VERSION}-1_arm64/srv/neo-cli/Plugins;
